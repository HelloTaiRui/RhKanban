...
export class RhWorldMapChart extends RhEchartsChart<RhWorldMapChart> {
  protected geoCoordMap = {
      ...
      return {
        ...
        coords: [
          ...
          [
            ...
            this.geoCoordMap[item.name][1] + item.value * lineMaxHeight(),
          ],
        ],
      };
    });
