...
export class DateHelper {
   ...
   * @param options 可选项
   */
  public static format(date: Date | number, formatDate = 'yyyy-MM-dd HH:mm:ss', options?: any): string {
   ...
   * @param date 日期
   */
  public static startOfWeek(date: Date | number, options = { weekStartsOn: 1 }): Date {
   ...
   * @param date 日期
   */
  public static endOfWeek(date: Date | number, options = { weekStartsOn: 1 }): Date {
